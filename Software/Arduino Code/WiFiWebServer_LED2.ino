...
int yaw = 0;
        ...
        //double Kp = 200, Ki = 0, Kd = 0; // PID−parameters 
...
//        
//            // Code for PID 
//          setpoint = 10; // User input to slew to desired orientation.
...
//  client.println("</td><td><a href='/redLED/on'>ON</a> / <a href='/redLED/off'>OFF</a></td></tr>");  // display redLED control links
  ...
  client.println("</td><td><a href='/20deg/on'>20</a> / <a href='/45deg/on'>45</a></td></tr>");
...
void performRequest(String line) {
  ...
  } else if (line.endsWith("GET /20deg/on")) {   // turn on yellow LED
    yaw = 20;
  } else if (line.endsWith("GET /45deg/on")) {  // turn off yellow LED
    yaw = 45;
